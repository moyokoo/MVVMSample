...
public class AnimHelper {
    ...
    @UiThread
    private static void animateVisibility(@Nullable final View view, final boolean show, int visibility) {
        if (view == null) {
            return;
        }
    ...
    @UiThread
    public static void animateVisibility(@Nullable final View view, final boolean show) {
        animateVisibility(view, show, View.GONE);
    }

    @UiThread
    private static void animateSafeVisibility(final boolean show, @NonNull final View view, int visibility) {
        view.animate().cancel();
    ...
    @UiThread
    public static void dismissDialog(@NonNull DialogFragment dialogFragment, int duration, AnimatorListenerAdapter listenerAdapter) {
    ...
    @UiThread
    public static void mimicFabVisibility(boolean show, @NonNull View view,
