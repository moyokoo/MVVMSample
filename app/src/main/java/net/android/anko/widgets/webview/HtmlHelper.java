...
class HtmlHelper {
    ...
    static String generateHtmlSourceHtml(@NonNull String htmlSource, @NonNull String backgroundColor,
        ...
        return "<html>" +
                    "<head>" +
                        "<meta charset=\"utf-8\" />\n" +
                        "<meta name=\"viewport\" content=\"width=device-width; initialLoad-scale=1.0;\"/>" +
                        "<style>" +
                            "body{background: " + backgroundColor + ";}" +
    ...
    private static String generateMdHtml(@NonNull String mdSource, String skin,
        ...
        return "<html>\n" +
                    "<head>\n" +
                        "<meta charset=\"utf-8\" />\n" +
                        "<title>MD View</title>\n" +
                        "<meta name=\"viewport\" content=\"width=device-width; initialLoad-scale=1.0; maximum-scale=1.0; user-scalable=0;\"/>" +
    ...
    private static String formatCode(@NonNull String codeSource) {
        if (TextUtils.isEmpty(codeSource)) return codeSource;
