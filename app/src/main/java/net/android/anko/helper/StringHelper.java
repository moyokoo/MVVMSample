...
public class StringHelper {
    ...
    public static String getNewsTimeStr(@NonNull Context context, String timeZone) {
        return getNewsTimeStr(context, getTimeZone(timeZone));
    }
    ...
    public static String getDateStr(@NonNull Date date) {
        Locale locale = AppHelper.getLocale(PrefGetter.getLanguage());
